            ...
            try:
                ...
                if attempt < max_retries:
                    ...
                    print(f'[GEMINI] {model} exhausted {max_retries} retries — '
                          f'{"trying next model" if model != _GEMINI_MODELS[-1] else "giving up"}')
...
# ── Grammar Topics for Language subjects (English, Hindi & Sanskrit) ──────────
...
GRAMMAR_TOPICS = {
    ...
    "Sanskrit": {
        "1":  ["वर्णमाला (Varnamala)", "स्वर एवं व्यंजन (Svar & Vyanjan)",
               "सरल शब्द-निर्माण (Simple Word Formation)", "संख्याएँ १–१० (Numbers 1–10)",
               "लिंग-परिचय (Gender Introduction)", "वचन-परिचय (Singular/Plural Introduction)",
               "सरल वाक्य (Simple Sentences — अस्ति/सन्ति)"],
        "2":  ["वर्णमाला एवं उच्चारण", "स्वर-व्यंजन", "सरल शब्द-रूप (अकारांत — बालः)",
               "क्रिया-परिचय (अस्ति / स्तः / सन्ति)", "लिंग एवं वचन",
               "संख्याएँ १–२०", "सरल वाक्य-निर्माण"],
        "3":  ["अकारांत पुल्लिंग शब्द-रूप (राम, बालक)",
               "आकारांत स्त्रीलिंग शब्द-रूप (लता, बाला)",
               "सर्वनाम (अहम् / त्वम् / सः / सा)",
               "सरल क्रिया-रूप (लट् लकार — प्रथम पुरुष)",
               "लिंग एवं वचन", "संख्याएँ १–५०",
               "सरल वाक्य एवं अनुवाद (हिन्दी से संस्कृत)"],
        "4":  ["अकारांत पुल्लिंग एवं स्त्रीलिंग शब्द-रूप",
               "इकारांत शब्द-रूप (कवि, मुनि)",
               "लट् लकार — तीनों पुरुष एवं वचन",
               "लोट् लकार (आज्ञा / अनुरोध)",
               "सर्वनाम (अस्मद् / युष्मद् / तद्)",
               "विशेषण-विशेष्य मेल", "संख्याएँ १–१००",
               "सरल अनुवाद एवं वाक्य-निर्माण"],
        "5":  ["अकारांत / आकारांत / इकारांत / उकारांत शब्द-रूप",
               "लट् लकार एवं लोट् लकार",
               "लङ् लकार (भूतकाल — परिचय)",
               "सर्वनाम (सर्वनाम-रूप)", "विशेषण",
               "कारक-परिचय (प्रथमा से षष्ठी)", "अव्यय (च / अपि / एव / तु / किन्तु)",
               "संख्यावाचक शब्द", "सरल अनुवाद (हिन्दी–संस्कृत)"],
        "6":  ["शब्द-रूप — अकारांत पुल्लिंग / स्त्रीलिंग / नपुंसकलिंग",
               "इकारांत एवं उकारांत शब्द-रूप",
               "सर्वनाम-रूप (तद् / एतद् / किम्)",
               "धातु-रूप — लट् लकार (भू / गम् / पठ् / खाद्)",
               "लोट् लकार एवं लङ् लकार",
               "कारक एवं विभक्ति (सभी विभक्तियाँ)", "अव्यय",
               "संधि-परिचय (स्वर संधि — सरल)", "समास-परिचय",
               "वाक्य-निर्माण एवं अनुवाद"],
        "7":  ["शब्द-रूप (ऋकारांत / दीर्घ इकारांत / दीर्घ उकारांत)",
               "संज्ञा-सर्वनाम-विशेषण मेल",
               "धातु-रूप — लट् / लोट् / लङ् / लृट् लकार",
               "कारक एवं विभक्ति (प्रयोग सहित)",
               "स्वर संधि (दीर्घ / गुण / वृद्धि / यण् / अयादि)",
               "समास (अव्ययीभाव / तत्पुरुष — परिचय)",
               "उपसर्ग (प्र / सम् / अनु / अव / नि / आ / वि / अभि / सु / दुर्)",
               "अव्यय", "चित्र-वर्णन एवं अनुवाद"],
        "8":  ["शब्द-रूप (व्यंजनांत — राजन् / आत्मन् / नामन्)",
               "धातु-रूप (लट् / लोट् / लङ् / लृट् / विधिलिङ् लकार)",
               "कारक एवं उपपद विभक्ति",
               "संधि (स्वर / व्यंजन / विसर्ग संधि — परिचय)",
               "समास (तत्पुरुष / कर्मधारय / द्विगु / द्वन्द्व)",
               "उपसर्ग एवं प्रत्यय (कृत् — परिचय)",
               "अव्यय", "वाच्य-परिचय (कर्तृवाच्य / कर्मवाच्य)",
               "पत्र-लेखन (संस्कृत में)", "अनुवाद (हिन्दी–संस्कृत)"],
        "9":  ["संधि (स्वर / व्यंजन / विसर्ग — विस्तृत)",
               "समास (सभी प्रकार — अव्ययीभाव / तत्पुरुष / कर्मधारय / द्विगु / द्वन्द्व / बहुव्रीहि)",
               "शब्द-रूप (सभी प्रमुख प्रकार)",
               "धातु-रूप (लट् / लोट् / लङ् / लृट् / विधिलिङ् / लिट् लकार)",
               "कारक एवं विभक्ति", "उपसर्ग",
               "कृत् प्रत्यय (क्त / क्तवतु / शतृ / शानच् / ण्यत्)",
               "तद्धित प्रत्यय (परिचय)", "अव्यय",
               "वाच्य (कर्तृ / कर्म / भाव)", "अशुद्धि-शोधन",
               "अनुवाद (हिन्दी–संस्कृत)", "पत्र-लेखन"],
        "10": ["संधि (स्वर / व्यंजन / विसर्ग)",
               "समास (सभी भेद — विग्रह सहित)",
               "शब्द-रूप (व्यंजनांत एवं विशेष शब्द)",
               "धातु-रूप (सभी प्रमुख लकार)",
               "कारक एवं विभक्ति (वाक्य-प्रयोग सहित)",
               "उपसर्ग एवं प्रत्यय (कृत् / तद्धित)",
               "वाच्य-परिवर्तन (कर्तृ ↔ कर्म ↔ भाव)",
               "अव्यय", "अशुद्धि-शोधन",
               "अनुवाद (हिन्दी–संस्कृत एवं संस्कृत–हिन्दी)",
               "अपठित गद्यांश", "पत्र-लेखन"],
        "11": ["संधि (विस्तृत — सभी प्रकार)",
               "समास (सभी प्रकार — विस्तृत विग्रह)",
               "शब्द-रूप (दुर्लभ एवं विशेष शब्द)",
               "धातु-रूप (परस्मैपद / आत्मनेपद / उभयपद)",
               "लकार (सभी दस लकार — परिचय एवं प्रयोग)",
               "कारक एवं उपपद विभक्ति", "उपसर्ग",
               "कृत् प्रत्यय (विस्तृत)", "तद्धित प्रत्यय",
               "वाच्य (कर्तृ / कर्म / भाव — विस्तृत)",
               "अलंकार (उपमा / रूपक / उत्प्रेक्षा / अनुप्रास / यमक / श्लेष)",
               "छन्द (अनुष्टुप् / इन्द्रवज्रा / उपेन्द्रवज्रा / वसन्ततिलका)",
               "अनुवाद", "अपठित गद्यांश / पद्यांश", "निबन्ध-लेखन"],
        "12": ["संधि (संपूर्ण — सभी प्रकार)",
               "समास (संपूर्ण — बहुव्रीहि विस्तृत)",
               "शब्द-रूप एवं धातु-रूप (उन्नत स्तर)",
               "लकार (सभी दस लकार — विस्तृत प्रयोग)",
               "कारक एवं विभक्ति", "उपसर्ग एवं प्रत्यय",
               "कृत् एवं तद्धित प्रत्यय", "कृदन्त एवं तद्धितान्त शब्द",
               "वाच्य-परिवर्तन", "वाक्य-संरचना एवं अशुद्धि-शोधन",
               "अलंकार (विस्तृत)", "छन्द (विस्तृत)",
               "अनुवाद (हिन्दी–संस्कृत एवं संस्कृत–हिन्दी)",
               "अपठित बोध (गद्य / पद्य / नाट्यांश)", "निबन्ध-लेखन"],
    },
}
...
Generate ALL {total_q_count} questions exactly as specified above. Each section must contain EXACTLY the number of questions stated — do not add extra questions, do not omit any. Make every question appropriate for Class {class_num} {subject} {board} students."""
        ...
        if any(x in err_str for x in ('503', 'UNAVAILABLE', 'high demand')):
            ...
            msg = ('AI quota exhausted. Please wait 1–2 minutes and try again. '
                   'If this keeps happening, your API key may have hit its daily limit — '
